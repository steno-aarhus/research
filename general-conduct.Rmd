...
# Need to add link to the "four social rules" (really good), but don't know how. Can U help? #
...
Unacceptable behavior has to stop immediately after being pointed out. Sanctions include??

Note: the region has an e-dok instruction on harassment. Will need to check e-dok and add to this document.
