...
consider the number of participants (few better than many) and their competences (whose opinions count)
- *Information sharing*: the objective is to spread awareness to a broader team (conside)
...
# Before the meeting
- Make sure that everybody is familiar with code of conduct and meeting rules
...
- Consider medium (in-person: room size, lighting, temperature, chairs and/or virtual meeting), time of the day, refreshments, etc
- Organizer meets early and ensures that the all relevant materials (paper, pens, stickynotes, etc) and technical equipment (pc, projector, camera, etc) are present and functioning
...
- Plan to engage people or check in on attendees often (examples below)
...
- A note taker is responsible for documenting clear and concise minute
...
*Sources:
- https://slack.com/intl/en-dk/blog/productivity/run-effective-meetings
- https://www.nature.com/articles/d41586-019-02295-z
- https://www.forbes.com/sites/forbesleadershipforum/2014/02/05/seven-steps-to-running-the-most-effective-meeting-possible/
