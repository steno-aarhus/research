...
2.  Decide on a name for your project. This should be a short,
    ...
    `on-limit`.
3.  Send your GitHub username and the name of your project to one of
    the `steno-aarhus` administrators, e.g., Luke Johnston
    ([lwjohnst\@clin.au.dk](mailto:lwjohnst@clin.au.dk){.email}) or Signe Kirk Brødbæk ([signekb\@clin.au.dk](mailto:signekb@clin.au.dk){.email}).
...
you need to do are [Navigating GitHub](#navigating-github) and
[Adding content](#adding-content-to-website).
...
For a quick introduction to GitHub, check out the [navigating a GitHub repository](/contributing/navigating-github.md) guide. 

::: callout-tip
## Want to learn more about GitHub?

If you want to learn more about GitHub, we recommend this
[Introduction to GitHub](https://github-intro.rostools.org/) workshop. All the material is on the website and you can work through it at your own pace.
...
add a page called "Om projektet" in a file named `about.md`, you need
...
you for example wanted to add a page called "Om os" in a file called `about-us.md`, you would add the
